...
const int SERVO2_MIN = 20;
const int SERVO2_MAX = 160;

const int CLAW_MIN = 40;
const int CLAW_MAX = 140;

// ==========================
// Optional motor inversion
// Flip true if motion is backwards
// ==========================
bool invertLeftDrive  = false;
    ...
    if (c == '\n') {
      ...
      // --------------------------
        ...
        if (comma > 0) {
          ...
          if (dir == -1) servo1Pos -= 2;
          else if (dir == 1) servo1Pos += 2;
      ...
      // --------------------------
        ...
        if (comma > 0) {
          int dir = input.substring(comma + 1).toInt();
          if (dir == -1) servo2Pos -= 2;
          else if (dir == 1) servo2Pos += 2;
